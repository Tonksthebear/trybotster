...
const OneTimeKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_onetimekey_free(ptr >>> 0, 1));

const SessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_session_free(ptr >>> 0, 1));

const SessionCreationResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sessioncreationresult_free(ptr >>> 0, 1));
...
export class Account {
     ...
     */
    identity_keys() {
        const ret = wasm.account_identity_keys(this.__wbg_ptr);
     ...
     */
    max_one_time_keys() {
        const ret = wasm.account_max_one_time_keys(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    create_inbound_session(their_identity_key, message) {
        ...
        return SessionCreationResult.__wrap(ret[0]);
    }
    /**
    ...
    create_outbound_session(their_identity_key, their_one_time_key) {
        const ptr0 = passStringToWasm0(their_identity_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(their_one_time_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    pickle() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.account_pickle(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class EncryptedMessage {
     ...
     */
    get message_type() {
        const ret = wasm.encryptedmessage_message_type(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    constructor(message_type, ciphertext) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encryptedmessage_new(message_type, ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
...
export class IdentityKeys {
    ...
    get curve25519() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.identitykeys_curve25519(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get ed25519() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.identitykeys_ed25519(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export class OneTimeKey {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        OneTimeKeyFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_onetimekey_free(ptr, 0);
    }
    /**
     * Get the key (base64)
     * @returns {string}
    ...
    get key() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.onetimekey_key(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get key_id() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.onetimekey_key_id(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) OneTimeKey.prototype[Symbol.dispose] = OneTimeKey.prototype.free;
...
export class Session {
    ...
    static from_pickle(pickle) {
        const ptr0 = passStringToWasm0(pickle, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.session_from_pickle(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Session.__wrap(ret[0]);
    ...
    pickle() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.session_pickle(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
 ...
 */
export class SessionCreationResult {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SessionCreationResult.prototype);
        obj.__wbg_ptr = ptr;
        SessionCreationResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SessionCreationResultFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sessioncreationresult_free(ptr, 0);
    }
    /**
     ...
     */
    take_session() {
        const ret = wasm.sessioncreationresult_take_session(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Session.__wrap(ret[0]);
     ...
     */
    plaintext_bytes() {
        const ret = wasm.sessioncreationresult_plaintext_bytes(this.__wbg_ptr);
    ...
    plaintext_string() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.sessioncreationresult_plaintext_string(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) SessionCreationResult.prototype[Symbol.dispose] = SessionCreationResult.prototype.free;
