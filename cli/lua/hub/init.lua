...
if safe_require("lib.entity_broadcast") then
    local core_entities = safe_require("hub.core_entities")
    if core_entities and type(core_entities.register) == "function" then
        core_entities.register()
    end
