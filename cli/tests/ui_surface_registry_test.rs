...
#[test]
#[ignore = "Architecturally dead under wire protocol: layout_broadcast/per-subscription dedup + input_builder semantics were removed in commit 7. Replaced by global (surface,subpath) dedup in lib.tree_snapshot (no per-sub state to test)."]
