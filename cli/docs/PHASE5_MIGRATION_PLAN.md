...
cd /Users/exampleuser/Rails/trybotster/cli && cargo test

# Rails tests should pass
cd /Users/exampleuser/Rails/trybotster && bin/rails test test/integration/cli_agent_lifecycle_test.rb test/system/terminal_relay_test.rb
```
...
```bash
# Rust tests
cd /Users/exampleuser/Rails/trybotster/cli
cargo test
cargo clippy

# Rails integration tests
cd /Users/exampleuser/Rails/trybotster
