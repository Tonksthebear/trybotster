...
# - Send notifications when agents need user input (POST /hubs/:identifier/notifications)
#
...
class Hubs::NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  # ==========================================================================
  # POST /hubs/:identifier/notifications - Send notification
  # ==========================================================================

  test "POST /hubs/:identifier/notifications returns 401 without authentication" do
    post hub_notifications_url(@hub.identifier),
  ...
  test "POST /hubs/:identifier/notifications returns 404 for unknown hub" do
    post hub_notifications_url("nonexistent-hub"),
      params: { notification_type: "question_asked", repo: "owner/repo", issue_number: 42 }.to_json,
  ...
  test "POST /hubs/:identifier/notifications requires repo and issue_number" do
    post hub_notifications_url(@hub.identifier),
  ...
  test "POST /hubs/:identifier/notifications accepts invocation_url" do
  ...
  test "POST /hubs/:identifier/notifications accepts legacy repo and issue_number params" do
    with_stubbed_github do
      post hub_notifications_url(@hub.identifier),
        params: {
  ...
  test "POST /hubs/:identifier/notifications returns error for invalid invocation_url" do
    post hub_notifications_url(@hub.identifier),
      params: {
        notification_type: "question_asked",
  ...
  test "POST /hubs/:identifier/notifications returns 401 if GitHub not authorized" do
    # User without GitHub authorization
    users(:primary_user).update!(github_app_token: nil)
  ...
  test "POST /hubs/:identifier/notifications supports different notification types" do
    with_stubbed_github do
